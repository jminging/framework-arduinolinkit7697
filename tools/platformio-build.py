...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_DIR, "system", "linkit_7697",
             "src", "driver", "chip", "mt7687", "inc"),
        join(FRAMEWORK_DIR, "system", "linkit_7697", "src",
        ...
        join(FRAMEWORK_DIR, "system", "linkit_7697", "src", "kernel",
             "rtos", "FreeRTOS", "Source", "portable", "GCC", "ARM_CM4F"),
        join(FRAMEWORK_DIR, "system", "linkit_7697", "src",
