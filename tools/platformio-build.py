...
default_common_settings = {
    'MTK_LWIP_ENABLE': True,
    'MTK_WIFI_CONFIGURE_FREE_ENABLE': False,
    'MTK_WIFI_PROFILE_ENABLE': False,
    'MTK_CLI_TEST_MODE_ENABLE': False,
    'MTK_WIFI_TGN_VERIFY_ENABLE': False,
    'MTK_HIF_GDMA_ENABLE': False,
    'MTK_MAIN_CONSOLE_UART2_ENABLE': False,
    'MTK_BSP_LOOPBACK_ENABLE': False,
    'MTK_OS_CPU_UTILIZATION_ENABLE': False,
    'MTK_SUPPORT_HEAP_DEBUG': False,
    'MTK_HEAP_SIZE_GUARD_ENABLE': False,
    'MTK_MPERF_ENABLE': False,
    'MTK_FW_DW_BY_CM4': False,
    'MTK_FLASH_DIRECT_DL': True,
    'MTK_PATCH_DL_ENABLE': True,
    'MTK_ANT_DIV_ENABLE': False
}

if default_common_settings['MTK_WIFI_TGN_VERIFY_ENABLE']:
    default_common_settings['MTK_HIF_GDMA_ENABLE'] = True
...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_DIR, "system", "linkit_7697", "src", "middleware", "third_party", "ping", "inc"),
        join(FRAMEWORK_DIR, "system", "linkit_7697", "src", "middleware", "third_party", "httpd", "inc"),
        join(FRAMEWORK_DIR, "system", "linkit_7697", "src", "middleware", "third_party", "cjson", "inc"),
